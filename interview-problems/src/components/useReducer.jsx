// The useReducer hook is a state management hook in React 
// that provides an alternative to the useState hook. 
// It is used when the state of a component is complex 
